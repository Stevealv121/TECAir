...
public class Utilities {
    ...
    public static final String TABLE_FAR = "flights_and_routes";
    ...
    public static final String CREATE_SEATS_TABLE = "CREATE TABLE "+TABLE_SEATS+" ("+FIELD_ID+" INTEGER, "+FIELD_DESCRIPTION+" TEXT, "+FIELD_STATUS+" BOOLEAN, "+FIELD_UID+" INTEGER, "+FIELD_APLATE+" TEXT)";
    public static final String CREATE_USER_TABLE = "CREATE TABLE "+TABLE_USER+" ("+FIELD_ID+" INTEGER, "+FIELD_EMAIL+" TEXT, "+FIELD_FNAME+" TEXT, "+FIELD_SNAME+" TEXT, "+FIELD_FSNAME+" TEXT, "+FIELD_SSNAME+" TEXT, "+FIELD_PHONE+" INTEGER, "+FIELD_UNIVERSITY+" TEXT, "+FIELD_STID+" INTEGER, "+FIELD_RNAME+" TEXT,"+FIELD_PASS+" TEXT)";
    public static final String CREATE_FAR_TABLE =  "CREATE TABLE "+TABLE_FAR+" ("+FIELD_ID+" INTEGER, "+FIELD_BGATE+" INTEGER, "+FIELD_PRICE+" INTEGER, "+FIELD_STATUS+" BOOLEAN, "+FIELD_RCODE+" INTEGER, "+FIELD_APLATE+" TEXT, "+FIELD_ORIGIN+" TEXT, "+FIELD_DESTINATION+" TEXT, "+FIELD_YEAR+" INTEGER, "+FIELD_MONTH+" INTEGER, "+FIELD_DAY+" INTEGER, "+FIELD_HOUR+" INTEGER, "+FIELD_MINUTES+" TEXT, "+FIELD_PCODE+" INTEGER, "+FIELD_FID+" INTEGER, "+FIELD_FPRICE+" INTEGER, "+FIELD_DURATION+" TEXT)";
