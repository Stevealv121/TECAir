...
public class Utilities {
    ...
    public static final String CREATE_USER_TABLE = "CREATE TABLE "+TABLE_USER+" ("+FIELD_ID+" INTEGER PRIMARY KEY AUTOINCREMENT NOT NULL, "+FIELD_EMAIL+" TEXT, "+FIELD_FNAME+" TEXT, "+FIELD_SNAME+" TEXT, "+FIELD_FSNAME+" TEXT, "+FIELD_SSNAME+" TEXT, "+FIELD_PHONE+" INTEGER, "+FIELD_UNIVERSITY+" TEXT, "+FIELD_STID+" INTEGER, "+FIELD_RNAME+" TEXT,"+FIELD_PASS+" TEXT)";
